...
(defun eziam-apply-custom-theme (theme-name)
  (let ((class '((class color) (min-colors 256)))
    ...
    (custom-theme-set-faces
     ...
     `(org-scheduled-today                              ((t (:foreground ,color-8))))
     ...
     `(outline-3                                        ((t (:foreground ,color-7))))
     `(outline-4                                        ((t (:foreground ,color-8))))
     `(outline-5                                        ((t (:foreground ,color-8))))
     `(outline-6                                        ((t (:foreground ,color-8))))
     `(outline-7                                        ((t (:foreground ,color-4))))
     `(outline-8                                        ((t (:foreground ,color-4))))
     ;; p4
